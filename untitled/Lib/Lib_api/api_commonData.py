...
class courseData:
    def api_getCourse(self,inData):
        url=f'{HOST}/course/v1/common/getCourse'
        params = inData
        reps =requests.get(url=url,params=params)
        return reps.json()

    def api_getTextbook(self,inData):
        url=f'{HOST}/course/v1/common/getTextbook'
    ...
    def api_getTerm(self,inData):
        url=f'{HOST}/course/v1/common/getTerm'
        params = json.loads(inData)
        # print(params)
        reps =requests.get(url=url,params=params)
        return reps.json()
    ...
    def api_getVersion(self,inData):
        url=f'{HOST}/course/v1/common/getVersion'
        params = json.loads(inData)
        # print(params)
        reps =requests.get(url=url,params=params)
        return reps.json()
    ...
    def api_getTextbookDir(self, inData):
        url = f'{HOST}/course/v1/common/getTextbookDir'
        params = json.loads(inData)
        reps = requests.get(url=url, params=params)
        return reps.json()
