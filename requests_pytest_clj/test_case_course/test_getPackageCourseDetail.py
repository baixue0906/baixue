...
class TestGetPackageDetail():
    ...
    run_data = run_excel.get_all_values_of_sheet(sheet_name01)[18]
    sheet_name03 = run_excel.get_sheet_by_name('getPackageCourseDetail')
    ...
    def test_getSingleCourseDetail(self,method,url,header,courseCode,excepted):
        res = self.course_data.getPackageCourseDetail(method,url,header,courseCode,excepted)
...
if __name__ =='__main__':
    pytest.main('-v',['../test_case/test_getPackageCourseDetail.py'])
