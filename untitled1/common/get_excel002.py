...
class ParseExcel(object):
    ...
    # def __init__(self):
    #     DATA_Path = config_file().dir_conf()[2]
    ...
    #     row_values = []
    #     for colsNum in range(2, max_cols_num + 1):
    ...
    #     column_values = []
    #     for rowNum in range(1, max_row_num + 1):
...
if __name__ == '__main__':
    #DATA_Path = config_file().dir_conf()[2]
    #wk = load_workbook(DATA_Path)
    #excelFile = DATA_Path
    # aaa = ParseExcel().get_sheet_by_name('getTerm001')
    # print(aaa)
    bbb=ParseExcel().get_all_values_of_sheet("getTerm001")
